...
\begin{figure}
  ...
  \caption{The calculated net demand surface $Q$ by price and time, from market data of April 1st, 2011.}\label{fig::AAPL_20110401_Calibration_Q}
\end{figure}
\end{center}

After the net demand surface $Q$ is calculate, the net demand sensitivity $q$ is simply taking the first order differential of $Q(p)$. That is,
