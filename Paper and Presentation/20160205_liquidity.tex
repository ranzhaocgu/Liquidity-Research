...
With the simulations under risk neutral measure, the corresponding call option price, $c(\pi, \omega)$, with strike $K$ at given time $t$ is

$$
c(\pi, \omega) = \frac{1}{N} \max{\pi(t,\omega)-K,0} \qquad \omega = 1,2,\ldots,N 
$$

where $\pi$ is the clearing price at simulation time $t$. 
