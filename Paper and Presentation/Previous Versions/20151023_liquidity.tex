...
%TCIDATA{LastRevised=Friday, October 16, 2015 18:07:33}
...
q(p,t,\omega ) &=& \exp\left(\int_{x=0}^{p}h(x,t,\omega )dx\right)\text{ \ \ \ \ \ \ \ \ \
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \
...
\forall p\in 0,..,S \\
q(p,t,\omega ) &=& \exp\left(\sum_{x=0}^{p}h(x,t,\omega )dx\right)\text{ \ \ \ \ \ \ \ \ \
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \
\ \ \ \ \ \ \ \ }\forall p\in \lbrack 0,S] \\
